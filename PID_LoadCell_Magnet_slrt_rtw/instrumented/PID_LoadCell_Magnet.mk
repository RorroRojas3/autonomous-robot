...
MODEL           = PID_LoadCell_Magnet
MODULES         = rt_matrx.c rt_printf.c PID_LoadCell_Magnet_capi.c PID_LoadCell_Magnet_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = PID_LoadCell_Magnet.mk
...
MODELLIB                  = PID_LoadCell_Magnetlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = PID_LoadCell_Magnet_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\PID_LoadCell_Magnet_slrt_rtw
