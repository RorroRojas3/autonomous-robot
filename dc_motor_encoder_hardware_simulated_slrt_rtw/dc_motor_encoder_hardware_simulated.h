...
/* Block states (auto storage) for system '<Root>/If Action Subsystem' */
typedef struct {
  int8_T IfActionSubsystem_SubsysRanBC;/* '<Root>/If Action Subsystem' */
} DW_IfActionSubsystem_dc_motor_T;
...
typedef struct {
  ...
  DW_IfActionSubsystem_dc_motor_T IfActionSubsystem1;/* '<Root>/If Action Subsystem1' */
  DW_IfActionSubsystem_dc_motor_T IfActionSubsystem;/* '<Root>/If Action Subsystem' */
...
struct P_dc_motor_encoder_hardware_simulated_T_ {
  ...
  real_T Gain_Gain;                    /* Expression: 1
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Kp_Gain;                      /* Expression: 1.375
                                        * Referenced by: '<Root>/Kp'
                                        */
  real_T Kd_Gain;                      /* Expression: 0.6375
                                        * Referenced by: '<Root>/Kd'
                                        */
  real_T Integrator1_IC;               /* Expression: 0
                                        * Referenced by: '<Root>/Integrator1'
                                        */
  real_T Ki_Gain;                      /* Expression: 0.011
...
extern const rtwCAPI_ModelMappingStaticInfo*
  dc_motor_encoder_hardware_simulated_GetCAPIStaticMap(void);
 ...
 * '<S2>'   : 'dc_motor_encoder_hardware_simulated/If Action Subsystem'
 * '<S3>'   : 'dc_motor_encoder_hardware_simulated/If Action Subsystem1'
