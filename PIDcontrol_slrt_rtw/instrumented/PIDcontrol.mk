...
MODEL           = PIDcontrol
MODULES         = rt_matrx.c rt_printf.c PIDcontrol_capi.c PIDcontrol_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = PIDcontrol.mk
...
MODELLIB                  = PIDcontrollib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = PIDcontrol_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\PIDcontrol_slrt_rtw
