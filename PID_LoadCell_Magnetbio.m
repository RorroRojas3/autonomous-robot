...
bio(3).dim=[1,1];
bio(3).sigWidth=1;
bio(3).sigAddress='&PID_LoadCell_Magnet_B.LED';
bio(3).ndims=2;
bio(3).size=[];
...
bio(4).dim=[1,1];
bio(4).sigWidth=1;
bio(4).sigAddress='&PID_LoadCell_Magnet_B.DerivativePID';
bio(4).ndims=2;
bio(4).size=[];
...
bio(5).dim=[4,1];
bio(5).sigWidth=4;
bio(5).sigAddress='&PID_LoadCell_Magnet_B.Gain[0]';
bio(5).ndims=2;
bio(5).size=[];
...
bio(6).dim=[1,1];
bio(6).sigWidth=1;
bio(6).sigAddress='&PID_LoadCell_Magnet_B.Kd';
bio(6).ndims=2;
bio(6).size=[];
...
bio(7).dim=[1,1];
bio(7).sigWidth=1;
bio(7).sigAddress='&PID_LoadCell_Magnet_B.Ki';
bio(7).ndims=2;
bio(7).size=[];
...
bio(8).dim=[1,1];
bio(8).sigWidth=1;
bio(8).sigAddress='&PID_LoadCell_Magnet_B.Kp';
bio(8).ndims=2;
bio(8).size=[];
...
bio(9).dim=[1,1];
bio(9).sigWidth=1;
bio(9).sigAddress='&PID_LoadCell_Magnet_B.Setpoint';
bio(9).ndims=2;
bio(9).size=[];
...
bio(14).blkName='Q4 DI ';
bio(14).sigName='';
bio(14).portIdx=0;
bio(14).dim=[1,1];
bio(14).sigWidth=1;
bio(14).sigAddress='&PID_LoadCell_Magnet_B.Q4DI';
bio(14).ndims=2;
bio(14).size=[];
bio(14).isStruct=false;

bio(15).blkName='Analog Filter Design';
bio(15).sigName='';
bio(15).portIdx=0;
bio(15).dim=[1,1];
bio(15).sigWidth=1;
bio(15).sigAddress='&PID_LoadCell_Magnet_B.AnalogFilterDesign';
bio(15).ndims=2;
bio(15).size=[];
