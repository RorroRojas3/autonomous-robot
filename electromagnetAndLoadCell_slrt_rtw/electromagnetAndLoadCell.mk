...
MODEL           = electromagnetAndLoadCell
MODULES         = rt_matrx.c rt_printf.c electromagnetAndLoadCell_capi.c electromagnetAndLoadCell_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE        = electromagnetAndLoadCell.mk
...
S_FUNCTIONS     = adquanserq8.c daquanserq8.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = electromagnetAndLoadCelllib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = electromagnetAndLoadCell_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\electromagnetAndLoadCell_slrt_rtw
