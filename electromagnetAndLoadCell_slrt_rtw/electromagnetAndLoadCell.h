...
#ifndef RTW_HEADER_electromagnetAndLoadCell_h_
#define RTW_HEADER_electromagnetAndLoadCell_h_
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef electromagnetAndLoadCell_COMMON_INCLUDES_
# define electromagnetAndLoadCell_COMMON_INCLUDES_
...
#endif                                 /* electromagnetAndLoadCell_COMMON_INCLUDES_ */

#include "electromagnetAndLoadCell_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_electromagnetAndLoadCell RT_MODEL_electromagnetAndLoadCell_T

/* Definition for use in the target main file */
#define electromagnetAndLoadCell_rtModel RT_MODEL_electromagnetAndLoadCell_T
...
typedef struct {
  real_T DCInput;                      /* '<Root>/DC Input' */
  real_T Q4AD;                         /* '<Root>/Q4 AD' */
} B_electromagnetAndLoadCell_T;
...
} DW_electromagnetAndLoadCell_T;

/* Backward compatible GRT Identifiers */
#define rtB                            electromagnetAndLoadCell_B
#define BlockIO                        B_electromagnetAndLoadCell_T
#define rtP                            electromagnetAndLoadCell_P
#define Parameters                     P_electromagnetAndLoadCell_T
#define rtDWork                        electromagnetAndLoadCell_DW
#define D_Work                         DW_electromagnetAndLoadCell_T

/* Parameters (auto storage) */
struct P_electromagnetAndLoadCell_T_ {
  real_T DCInput_Value;                /* Expression: 0
...
struct tag_RTM_electromagnetAndLoadCell_T {
  const char_T *path;
...
extern P_electromagnetAndLoadCell_T electromagnetAndLoadCell_P;

/* Block signals (auto storage) */
extern B_electromagnetAndLoadCell_T electromagnetAndLoadCell_B;

/* Block states (auto storage) */
extern DW_electromagnetAndLoadCell_T electromagnetAndLoadCell_DW;

/*====================*
 * External functions *
 *====================*/
extern electromagnetAndLoadCell_rtModel *electromagnetAndLoadCell(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  electromagnetAndLoadCell_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_electromagnetAndLoadCell_T *const electromagnetAndLoadCell_M;
 ...
 *
 * '<Root>' : 'electromagnetAndLoadCell'
 * '<S1>'   : 'electromagnetAndLoadCell/Scope 1'
 * '<S2>'   : 'electromagnetAndLoadCell/Scope 2'
 */
#endif                                 /* RTW_HEADER_electromagnetAndLoadCell_h_ */
